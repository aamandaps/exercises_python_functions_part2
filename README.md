...
<p>c. Um procedimento main() que use valor como global e inicie uma variável contador
...
contador e o result como parâmetros;</p>
<p>d. A função mult deve receber o valor passado pelo usuário e o contador, deve
declarar uma variável local res, que recebe a multiplicação de vlr e tab e é a variável
de retorno da função;</p>
<p>e. O procedimento grava recebe como parâmetros o contador da estrutura de
